...
| Runner | Output |
| --- | --- |
| Windows | NSIS `.exe` and localized WiX `.msi` installers |
| macOS Apple Silicon | Signed, notarized, and stapled arm64 `.dmg` |
| macOS Intel | Signed, notarized, and stapled x64 `.dmg` |
