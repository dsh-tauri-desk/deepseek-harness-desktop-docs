...
<Frame>
  <img src="/images/en/first-run-download.png" alt="First-run Harness core download progress" />
</Frame>

<Frame>
  <img src="/images/en/first-run-plugins.png" alt="Selecting recommended plugins during first run" />
</Frame>
