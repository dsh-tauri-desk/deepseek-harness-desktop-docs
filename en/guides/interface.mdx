...
{/* <!-- [Desktop shell and embedded Harness interface with labeled regions](/images/en/interface-tour.webp) --> */}
...
{/* <!-- [Desktop Configuration dialog with four panels](/images/en/configuration-dialog.webp) --> */}
